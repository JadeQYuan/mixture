...
public class CaffeineConfig {
    ...
    public Cache<String, Object> globalCache() {
        return Caffeine.newBuilder()
            ...
            // 移除缓存监听
            .removalListener(
                (k, v, cause) -> log.info("NativeCache RemovalListener key:{}, value:{}, cause:{}", k, v, cause))
            .build();
    }
     ...
     * @return
     */
    public static org.springframework.cache.Cache buildCache(String cacheName, Duration expireTime, int initCapacity,
        int maxCapacity) {
        ...
        return new CaffeineCache(cacheName, Caffeine.newBuilder()
            ...
            // 移除缓存监听
            .removalListener(
                (k, v, cause) -> log.warn("NativeCache RemovalListener key:{}, value:{}, cause:{}", k, v, cause))
            .build());
    }
